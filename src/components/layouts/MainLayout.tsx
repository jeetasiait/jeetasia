...
const MainLayout: React.FC<MainLayoutProps> = ({ 
  ...
  const generateStructuredData = () => {
    ...
    const organizationStructuredData = {
      ...
      "name": "JEET Asia Private Limited",
      "url": baseUrl,
      "logo": `${baseUrl}/jeetasia-uploads/7e6f9b24-6c98-48a1-8e02-ff9bc51058f9.png`,
      "description": "Leading infrastructure and construction company specializing in large-scale road and railway projects across India since 2014.",
      "address": {
        "@type": "PostalAddress",
        "streetAddress": "B-3, 2nd Floor, Sector-2",
  ...
  // We only show a minimal loading state for the initial mount if necessary, 
  // but we prefer to let the page content render immediately for better UX.
